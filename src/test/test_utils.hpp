...
void checkIncrement4DimResponse(const std::string outputName,
    ...
    if (!checkInTensorProto) {
        ...
        ASSERT_EQ(response.outputs(0).datatype(), "UINT8");  // others not implemented
        ASSERT_EQ(sizeof(T), 1);  // other not implemented
